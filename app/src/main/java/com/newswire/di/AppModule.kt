...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideNewsRepository(client: OkHttpClient): NewsRepository =
        NewsRepository(client)

    @Provides
    @Singleton
    fun provideFactsRepository(client: OkHttpClient): FactsRepository =
        FactsRepository(client)
